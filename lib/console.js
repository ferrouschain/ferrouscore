...
*/
    ...
    async native_wallet(...args) {
        ...
        let walletBin = this.manager.getDeployableBinary('kaspawallet');
...
help(term) {
    switch(term) {
        default: {
            ...
            //migrate - upgrades Kasparov database schema\r
            this.terminal.write(`
native-wallet <command> - run native Kaspa CLI wallet command, where command is:\r
\r
...
\r
rpc [command] - run RPC command against the default Kaspad instance\r
\r
